      ...
      <div className="footer-content" style={styles.footerContent}>
        ...
        <div className="footer-section" style={styles.footerSection}>
          ...
          >
            ...
            <ul className="footer-links" style={styles.footerLinks}>
              ...
              <li style={styles.linkItem}><a href="#" style={styles.link}>Products</a></li>
              <li style={styles.linkItem}><a href="#" style={styles.link}>Services</a></li>
              <li style={styles.linkItem}><a href="#" style={styles.link}>Blog</a></li>
            </ul>
          </motion.div>
        </div>
        ...
        <div className="footer-section" style={styles.footerSection}>
          ...
          >
            ...
            <ul className="footer-links" style={styles.footerLinks}>
              <li style={styles.linkItem}><a href="#" style={styles.link}>Mossent</a></li>
              <li style={styles.linkItem}><a href="#" style={styles.link}>Activ-P</a></li>
              <li style={styles.linkItem}><a href="#" style={styles.link}>Zest</a></li>
            </ul>
          </motion.div>
        </div>
          ...
          >
            ...
            <ul className="footer-contact" style={styles.footerContact}>
              <li style={styles.contactItem}>
                ...
                <span>PAF-IAST Campus, Haripur KP</span>
              </li>
              <li style={styles.contactItem}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#44c2c7" viewBox="0 0 16 16" style={styles.contactIcon}>
                  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383-4.758 2.855L15 11.114v-5.73zm-.034 6.878L9.271 8.82 8 9.583 6.728 8.82l-5.694 3.44A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.739zM1 11.114l4.758-2.876L1 5.383v5.73z"/>
                </svg>
                <span>info@ceramedical.com</span>
              </li>
              <li style={styles.contactItem}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#44c2c7" viewBox="0 0 16 16" style={styles.contactIcon}>
